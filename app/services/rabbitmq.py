...
class RabbitConnector:
    ...
    async def _declare_channel(self, channel_number=None):
        'Declare channel'
        return await self._conn.channel(channel_number=channel_number)
    ...
    async def declare_queue(self, queue, durable=True):
        'Declare consumer queue'
        self.consumer_tag = queue
        return await self._channel.declare_queue(queue, durable=durable)
    ...
    async def connect(self, channel_number=None):
        ...
        # declare channel
        self._channel = await self._declare_channel(channel_number)
